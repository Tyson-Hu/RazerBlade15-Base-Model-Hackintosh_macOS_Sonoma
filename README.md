...
接着运行你下载好的Unblocker 302，**如果不运行的话你会发现后面打开虚拟机的时候一直重启（没错，无限重启，贼恶心🤮）**

[图片还在路上，马上就来了...]

接着进入VMWare Workstation Pro ，编辑虚拟机➡️新建磁盘➡️类型选择 SATA由选物理磁盘➡️选分区而不是整个硬盘，然后选中刚才创建的 APFS 容器 (**请根据分区大小判断**)   

[图片还在路上，马上就来了...]

虚拟机开机，直接进安装程序安装，无需再抹盘
