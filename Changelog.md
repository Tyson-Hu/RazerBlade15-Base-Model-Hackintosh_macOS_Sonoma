...
- Added IA32 binary variant to the release bundles (Ready to compiling)
- For older version macOS (Not & not gonna test, if you want challenge youself, do it!): (Ready to compiling)
